        ...
        <div className={styles.card}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.logos}>
                    ...
                    <object type="image/svg+xml" data="src\assets\techLogos\vsc.svg" className={styles.logo} />
                    <object type="image/svg+xml" data="src\assets\techLogos\linux.svg" className={styles.logo} width="250px" />
                    <object type="image/svg+xml" data="src\assets\techLogos\windows.svg" className={styles.logo} />
                </div>
