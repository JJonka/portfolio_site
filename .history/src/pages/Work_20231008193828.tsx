        ...
        <div className={styles.card}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.logos}>
                    ...
                    <ReactSVG src="src\assets\techLogos\react.svg" className={styles.logo} width="100px"/>
                    ...
                    <ReactSVG src="src\assets\techLogos\linux.svg" className={styles.logo} width="250px"/>
