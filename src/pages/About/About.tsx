      ...
      <Container page="container-about">
        <Item page="item1-about">
          <Box data-testid="Box">
            ...
            working on a web application for building depot, which ought to be a
            catalog of products. My role in this project not only includes
            programming, but also making decisions about which technology or
            solution to use. It gives me the opportunity to learn every step in
            application making. It is very challenging, but I find pleasure in
            designing, creating, and fixing things, so it gives me a great
            satisfaction.
          </Box>
        </Item>
      ...
      <Container page="container-work">
        ...
        <div className={styles.logos}>
          ...
          <div className={styles.line}>
            ...
            <TechIcon icon="/assets/techLogos/node.svg" tooltipText="Node.js" />
            <TechIcon
